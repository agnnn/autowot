...
public class ResourceDisplaySelectionListener implements SelectionListener{
	...
	public void widgetSelected(SelectionEvent arg0) {
		// Cocoa version calls method with arg0.item = null
		// which leads to problems with SWT
		if(arg0.item == null) {
			return;
		}
		...
		if (selectionIndex != 0) {
			if (mainUI.resourceDisplay.getViewStyle() == ViewStyle.XML) {
				...
				if (selectedCategory.startsWith("Getter")) {
					...
					if (selectedCategory.contains(":")) resourceName = selectedCategory.substring(0, selectedCategory.indexOf(":"));
					else resourceName = selectedCategory;
